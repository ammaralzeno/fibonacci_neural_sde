...
def get_trainer_cfg():
    ...
    trainer_cfg["run_cfg"] = dict(trainer_cfg["run_cfg"], run_name="exp3_corr_only")
    trainer_cfg["model_cfg"] = dict(trainer_cfg["model_cfg"], use_context=False, learn_corr=True)
    return trainer_cfg
